// WIN_API_2023_02.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//

#include "framework.h"
#include "WIN_API_2023_02.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_WINAPI202302, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_WINAPI202302));
...
struct Vector2
{
    ...
    float CrossScalar(const Vector2& other)
    {
        float newX = this->x * other.y;
        float newY = this->y * other.x;
    ...
    {
        float term;
        term = (this->x * this->x) + (this->y * this->y);
